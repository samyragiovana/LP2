...
namespace Academia {
    ...
    public partial class AcademiaDataSet : global::System.Data.DataSet {
        ...
        public partial class ClienteDataTable : global::System.Data.TypedTableBase<ClienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClienteRow AddClienteRow(string Nome, string Endereco, string Telefone, string Plano) {
        ...
        public partial class ClienteRow : global::System.Data.DataRow {
            ...
            public string Plano {
                get {
                    return ((string)(this[this.tableCliente.PlanoColumn]));
                }
                set {
                    this[this.tableCliente.PlanoColumn] = value;
                }
            }
        }
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cliente] WHERE (([Id] = @Original_Id) AND ([Nome] = @Original_" +
                "Nome) AND ([Endereco] = @Original_Endereco) AND ([Telefone] = @Original_Telefone" +
                ") AND ([Plano] = @Original_Plano))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cliente] ([Nome], [Endereco], [Telefone], [Plano]) VALUES (@No" +
                "me, @Endereco, @Telefone, @Plano);\r\nSELECT Id, Nome, Endereco, Telefone, Plano F" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cliente] SET [Nome] = @Nome, [Endereco] = @Endereco, [Telefone] = @Telefone, [Plano] = @Plano WHERE (([Id] = @Original_Id) AND ([Nome] = @Original_Nome) AND ([Endereco] = @Original_Endereco) AND ([Telefone] = @Original_Telefone) AND ([Plano] = @Original_Plano));
SELECT Id, Nome, Endereco, Telefone, Plano FROM Cliente WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nome, Endereco, Telefone, Plano FROM dbo.Cliente";
        ...
        public virtual int Delete(int Original_Id, string Original_Nome, string Original_Endereco, string Original_Telefone, string Original_Plano) {
            ...
            if ((Original_Plano == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_Plano));
            }
        ...
        public virtual int Insert(string Nome, string Endereco, string Telefone, string Plano) {
            if ((Nome == null)) {
            ...
            if ((Plano == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(Plano));
            }
        ...
        public virtual int Update(string Nome, string Endereco, string Telefone, string Plano, int Original_Id, string Original_Nome, string Original_Endereco, string Original_Telefone, string Original_Plano, int Id) {
            if ((Nome == null)) {
                throw new global::System.ArgumentNullException("Nome");
            }
            else {
            ...
            if ((Plano == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Plano));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, string Endereco, string Telefone, string Plano, int Original_Id, string Original_Nome, string Original_Endereco, string Original_Telefone, string Original_Plano) {
            return this.Update(Nome, Endereco, Telefone, Plano, Original_Id, Original_Nome, Original_Endereco, Original_Telefone, Original_Plano, Original_Id);
        }
    }
