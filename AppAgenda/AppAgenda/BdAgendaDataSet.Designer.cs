...
SELECT Id, nome, rua, numero, bairro, cidade, cep, telefone, email FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::AppAgenda.Properties.Settings.Default.BdAgendaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        Id, nome, rua, numero, bairro, cidade, cep, telefone, email\r\nFROM  " +
                "          [Table]\r\nWHERE        (nome LIKE @p)";
        ...
        public virtual int FillByName(BdAgendaDataSet.TableDataTable dataTable, string p) {
        ...
        public virtual BdAgendaDataSet.TableDataTable GetDataByName(string p) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((p == null)) {
                throw new global::System.ArgumentNullException("p");
            }
